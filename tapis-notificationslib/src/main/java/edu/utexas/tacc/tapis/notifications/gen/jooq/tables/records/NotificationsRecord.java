...
public class NotificationsRecord extends UpdatableRecordImpl<NotificationsRecord> implements Record8<Integer, Integer, String, Integer, UUID, JsonElement, JsonElement, LocalDateTime> {
    ...
    @Override
    public Row8<Integer, Integer, String, Integer, UUID, JsonElement, JsonElement, LocalDateTime> valuesRow() {
    ...
    @Override
    public NotificationsRecord values(Integer value1, Integer value2, String value3, Integer value4, UUID value5, JsonElement value6, JsonElement value7, LocalDateTime value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NotificationsRecord(Integer seqId, Integer subscrSeqId, String tenant, Integer bucketNumber, UUID eventUuid, JsonElement event, JsonElement deliveryMethod, LocalDateTime created) {
        super(Notifications.NOTIFICATIONS);
