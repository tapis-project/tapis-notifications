...
public class NotificationsRecoveryRecord extends UpdatableRecordImpl<NotificationsRecoveryRecord> implements Record13<Integer, UUID, Integer, String, String, Integer, UUID, JsonElement, JsonElement, Integer, LocalDateTime, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public Row13<Integer, UUID, Integer, String, String, Integer, UUID, JsonElement, JsonElement, Integer, LocalDateTime, LocalDateTime, LocalDateTime> fieldsRow() {
        return (Row13) super.fieldsRow();
    }

    @Override
    public Row13<Integer, UUID, Integer, String, String, Integer, UUID, JsonElement, JsonElement, Integer, LocalDateTime, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public NotificationsRecoveryRecord value2(UUID value) {
        setUuid(value);
        return this;
    }

    @Override
    public NotificationsRecoveryRecord value3(Integer value) {
    ...
    @Override
    public NotificationsRecoveryRecord value6(Integer value) {
    ...
    @Override
    public NotificationsRecoveryRecord values(Integer value1, UUID value2, Integer value3, String value4, String value5, Integer value6, UUID value7, JsonElement value8, JsonElement value9, Integer value10, LocalDateTime value11, LocalDateTime value12, LocalDateTime value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NotificationsRecoveryRecord(Integer seqId, UUID uuid, Integer subscrSeqId, String tenant, String subscrId, Integer bucketNumber, UUID eventUuid, JsonElement event, JsonElement deliveryMethod, Integer attemptCount, LocalDateTime lastAttempt, LocalDateTime created, LocalDateTime updated) {
        super(NotificationsRecovery.NOTIFICATIONS_RECOVERY);
