...
public class NotificationsRecoveryRecord extends UpdatableRecordImpl<NotificationsRecoveryRecord> implements Record12<UUID, Integer, String, Integer, UUID, JSONB, JsonElement, Integer, LocalDateTime, LocalDateTime, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public Row12<UUID, Integer, String, Integer, UUID, JSONB, JsonElement, Integer, LocalDateTime, LocalDateTime, LocalDateTime, LocalDateTime> fieldsRow() {
        return (Row12) super.fieldsRow();
    }

    @Override
    public Row12<UUID, Integer, String, Integer, UUID, JSONB, JsonElement, Integer, LocalDateTime, LocalDateTime, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public NotificationsRecoveryRecord values(UUID value1, Integer value2, String value3, Integer value4, UUID value5, JSONB value6, JsonElement value7, Integer value8, LocalDateTime value9, LocalDateTime value10, LocalDateTime value11, LocalDateTime value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public NotificationsRecoveryRecord(UUID uuid, Integer subscrSeqId, String tenant, Integer bucketNumber, UUID eventUuid, JSONB event, JsonElement deliveryMethod, Integer recoveryAttempt, LocalDateTime lastAttempt, LocalDateTime expiry, LocalDateTime created, LocalDateTime updated) {
        super(NotificationsRecovery.NOTIFICATIONS_RECOVERY);
