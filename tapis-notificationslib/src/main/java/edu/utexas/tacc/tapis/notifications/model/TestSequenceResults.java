...
/*
 * TODO: Results from a test sequence of notifications.
 * Includes the subscription and all events received during the test.
 */
public final class TestSequenceResults
{
  // ************************************************************************
  // *********************** Constants **************************************
  // ************************************************************************
   ...
   */
  public TestSequenceResults(String tf, List<DeliveryMethod> dmList1)
  {
    setTypeFilter(tf);
   ...
   */
  public TestSequenceResults(TestSequenceResults s, String tenant1, String id1)
  {
   ...
   */
  public TestSequenceResults(int seqId1, String tenant1, String id1, String description1, String owner1, boolean enabled1,
   ...
   */
  public TestSequenceResults(TestSequenceResults s)
  {
