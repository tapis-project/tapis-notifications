...
/*
 * CloudEvent in the Tapis ecosystem.
...
public final class CloudEvent
{
  ...
  /*                               Constants                                */
  /* ********************************************************************** */
  private static final Logger _log = LoggerFactory.getLogger(CloudEvent.class);
  ...
  private final String subject; // Subject of event in context of event producer (identified by source).
  ...
  /*                           Constructors                                 */
  /* ********************************************************************** */
    public CloudEvent(String id1, URI source1, String type1, String subject1, String datacontenttype1,
